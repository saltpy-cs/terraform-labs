...
1. In the HCP Terraform UI, click your **organisation name** in the top-left to go to the organisation overview (not the workspace).
2. In the left sidebar, click **Policy Sets**, then **Connect a new policy set**.
